...
<body>
	...
	<div style="padding-top:0 ;margin-top:0" class="container-fluid admin">
		<div class="col-md-12 alert alert-dark">Teachers List</div>
		<button class="btn btn-dark bt-sm" id="new_faculty"><i class="fa fa-plus"></i>	Add New</button>
		<br>
		<br>
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tr>
						...
						<td>
							<center>
								<button class="btn btn-sm btn-outline-dark edit_faculty" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i> Edit</button>
