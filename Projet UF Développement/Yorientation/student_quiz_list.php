...
<head>
	...
	<title>My Form List</title>
</head>
<body>
	<?php include('nav_bar.php') ?>
	
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-dark">My Form List</div>
		<br>
		<div class="card">
			<div class="card-body">
					...
					<tr>
						...
						<td>
							<center>
							 	...
							 	<a class="btn btn-sm btn-outline-dark" href="./answer_sheet.php?id=<?php echo $row['id']?>"><i class="fa fa-pencil"></i> Take Form</a>
								<?php else: ?>
								<a class="btn btn-sm btn-outline-dark" href="./view_answer.php?id=<?php echo $row['id']?>"><i class="fa fa-eye"></i> View</a>
							<?php endif; ?>
							</center>
						</td>
					</tr>
