...
<body>
	...
	<div style="padding-top:0 ;margin-top:0" class="container-fluid admin">
		<div class="col-md-12 alert alert-dark"><?php echo $qry['title'] ?></div>
		<button class="btn btn-dark bt-sm" id="new_question"><i class="fa fa-plus"></i>	Add Question</button>
		<button class="btn btn-dark bt-sm" id="new_student"><i class="fa fa-plus"></i>	Add Student</button>
		<br>
		<br>
				...
				<?php
					...
					while($row=$qry->fetch_array()){
						...
						<li class="list-group-item"><?php echo $row['question'] ?><br>
							<center>
								 <button class="btn btn-sm btn-outline-dark edit_question" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i></button>
